...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'cultural': '0 4px 20px -5px hsl(var(--primary) / 0.2)',
        'cultural-lg': '0 10px 40px -10px hsl(var(--primary) / 0.3)',
        'warm': '0 4px 20px -5px hsl(var(--secondary) / 0.2)',
        'warm-lg': '0 10px 40px -10px hsl(var(--secondary) / 0.3)',
      },
    },
  },
